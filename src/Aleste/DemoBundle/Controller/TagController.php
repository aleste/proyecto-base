...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AlesteDemoBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("AlesteDemoBundle:Tag:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AlesteDemoBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AlesteDemoBundle:Tag:edit.html.twig")
     */
